    ...
    public void createTable() {
        ...
        if(conn != null) {
            try {
                ...
                String table1 = MessageFormat.format("CREATE TABLE {0}_diary (date DATE, user_id CHAR(20), entry MEDIUMTEXT, CONSTRAINT PRIMARY KEY (date, " +
                        "User_id))", user);
                ...
                String table2 =
                        MessageFormat.format("CREATE TABLE {0}_nutrition (user_id CHAR(20),date DATE, food CHAR(20), cal INT, carbs INT, sugar INT, CONSTRAINT FOREIGN KEY (user_id, date) REFERENCES {1}_diary (user_id, date))", user, user);
